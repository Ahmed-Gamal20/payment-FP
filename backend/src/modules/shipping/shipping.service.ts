...
//   async createSession(cartId: string, shippingData: ShippingDTO) {
...
//     await this.saveShippingData(userId, shippingData);

//     return session;
//   }

//   private async saveShippingData(userId: string, shippingData: ShippingDTO) {
//     const shipping = new this.shippingModel({
//       userId: userId,
//       address: shippingData.details,
